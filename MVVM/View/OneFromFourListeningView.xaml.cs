...
namespace Filian.MVVM.View
{
    public partial class OneFromFourListeningView : UserControl
    {
        ...
        {
            InitializeComponent();
            OneFromFourListeningViewModel.Grid = MainGrid;
        }
        ...
        private void SelectAndMarkImage(object sender, ref bool isSelected)
        {
            ...
            if (!isSelected)
            {
                ...
                OneFromFourListeningViewModel.Column = Grid.GetColumn(selectedImage);
                OneFromFourListeningViewModel.Row = Grid.GetRow(selectedImage);
                isSelected = true;
            }
            else
            {
